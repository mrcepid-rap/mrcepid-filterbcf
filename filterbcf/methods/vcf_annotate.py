...
class VCFAnnotate:
    ...
    def _run_vep(self, input_vcf: Path) -> Path:
        ...
        loftee_path = Path("loftee_files/loftee_hg38")
        ...
        vep_caches_path = Path("vep_caches")
        ...
        cmd = (
            ...
            f'--dir_cache {vep_caches_path} --everything --allele_num --fork 4 '
            f'-i {input_vcf} --format vcf --fasta {fasta_path} '
            f'-o {output_vcf} --compress_output bgzip --vcf '
            ...
            f'gerp_bigwig:{gerp_file} --force_overwrite'
        )
