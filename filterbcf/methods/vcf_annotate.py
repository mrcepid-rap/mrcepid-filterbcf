...
class VCFAnnotate:
    ...
    def _run_vep(self, input_vcf: Path) -> Path:
        ...
        # We do NOT use Path.cwd() here because we don't want the Executor to see Host paths.
        ...
        # 3. CRITICAL CHANGE: Protect BOTH the internal VEP dir AND our manual mount point.
